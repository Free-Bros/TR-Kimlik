SWEP.PrintName = "İşletme Belgesi Bireysel"
	...
	if !IsValid(vm) then return end
		...
		if (m) then
			...
			cam.Start3D2D(pos+ang:Right()*3+ang:Forward()*-1.80+ang:Up()*1.0, ang, 0.02)
					...
					draw.SimpleText("Bireysel", "PassHud3", 40, -5, Color(0,0,0,255))
					draw.SimpleText("Alınacak Vergi:", "PassHud2", 40, 15, Color(0,0,0,255))
					draw.SimpleText("Çalışan başına 900₺", "PassHud3", 40, 30, Color(0,0,0,255))
